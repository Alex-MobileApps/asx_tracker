...
class SimulatorHomeMenu(Menu):
    ...
    def __init__(self, **kwargs):
        super().__init__(title = 'Trading simulator')
        self.start = SimulatorHomeMenu._DEF_START
        self.broke = SimulatorHomeMenu._DEF_BROKE
        self.balance = SimulatorHomeMenu._DEF_BALANCE
        self.delay = SimulatorHomeMenu._DEF_DELAY_MIN
        self.step_min = SimulatorHomeMenu._DEF_STEP_MIN
        self.cgt = SimulatorHomeMenu._DEF_CGT
        self.set_options()
